...
sigma_hat, beta_hat, obj = blp.estimate_blp_sigma(
    test_markets, 
    iv_type="cost", 
    R=200
)
...
# 3. Evaluate Results
print("\n--- Recovery Results ---")
print(f"Parameter | True Value | Estimated | Bias")
print(f"Sigma     | {cfg.sigma_true:10.3f} | {sigma_hat:9.3f} | {sigma_hat - cfg.sigma_true:.3f}")
print(f"Intercept | {cfg.xi_bar:10.3f} | {beta_hat[0]:9.3f} | {beta_hat[0] - cfg.xi_bar:.3f}")
print(f"Beta_p    | {cfg.beta_p_true:10.3f} | {beta_hat[1]:9.3f} | {beta_hat[1] - cfg.beta_p_true:.3f}")
print(f"Beta_w    | {cfg.beta_w_true:10.3f} | {beta_hat[2]:9.3f} | {beta_hat[2] - cfg.beta_w_true:.3f}")